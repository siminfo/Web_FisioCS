        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8 content">
                    <div class="thumb">
                        <img src="assets/img/manual.jpg" alt="Thumb">
                    </div>
                    <div class="info">
                        <h2>Terapia Manual</h2>
                        <p>
                        La terapia manual es nuestra principal herramienta, trabajamos con técnicas y terapias manuales altamente eficaces que aportan numerosos beneficios para la salud.

 

                        Constituye uno de los pilares básicos de la medicina como respuesta terapéutica.



                        Las técnicas de Terapia Manual son técnicas específicas para el tratamiento del dolor y otros síntomas de disfunción neuro-músculo-esquelética de la columna vertebral y de las extremidades, que se caracterizan por ser aplicadas manualmente y/o de forma instrumental. Aplicaremos distintas técnicas centradas en el sistema musculoesquelético para resolver los problemas corporales.
                    ...
                    <div class="widget link">
                        ...
                        <ul>
                          <li>
                            ...
                            <li>
                                <a href="<?= base_url('yoga') ?>"><i class="fas fa-angle-right"></i>Yoga</a>
                            </li>
                            <li>
