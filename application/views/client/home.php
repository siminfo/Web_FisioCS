    ...
    <!-- Start About
    ============================================= -->
    <div class="about-area default-padding" name="clinica" id="clinica">
        <div class="container" >
            <div class="row">
                           ...
                           <!--  <div id="tab1" class="tab-pane fade active in">
                            ...
                            <div id="tab2" class="tab-pane fade">
                                <div class="info title">
                                    <h3>Localización</h3>
                                    <p>
                                        Nos encontramos en la ciudad de Alicante en la calle Alcalde José Luis Lassaletta, 17  en el barrio de Babel.
                                    </p>
                                   <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3830.7730626817524!2d-0.5075102299901929!3d38.3355633261114!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd62363f9a5078c7%3A0x8bb37b912b24d27!2sCarrer%20Alcalde%20Jos%C3%A9%20Lu%C3%ADs%20Lassaletta%2C%2017%2C%2003008%20Alicante%20(Alacant)%2C%20Alicante!5e0!3m2!1ses!2ses!4v1583753924180!5m2!1ses!2ses" ></iframe>
                                </div>
                            </div>
                            <!-- End Single Item -->
    ...
    <!-- Start Services 
    ============================================= -->
    <div class="services-area inc-icon bg-gray carousel-shadow default-padding"  name="servicios" id="servicios">
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6 item">
                    <div class="fun-fact">
                        ...
                        <span class="medium">Pacientes satisfechos</span>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 item">
                    <div class="fun-fact">
                        ...
                        <span class="medium">Terapias realizadas</span>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 item">
                    <div class="fun-fact">
                        ...
                        <span class="medium">Doctores</span>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 item">
                    <div class="fun-fact">
                        ...
                        <span class="medium">Comentarios</span>
                    </div>
                </div>
            </div>
        </div>
