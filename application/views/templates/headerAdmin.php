              ...
              <!--   <div class="attr-nav">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    ...
                    <ul class="nav navbar-nav navbar-right" data-in="#" data-out="#">
                        ...
                        <li>  <a style="margin-top: 1.4px;" href="<?= base_url('homeAdmin') ?>" >Administración</a></li>
                        <li>
                            <a href="<?= base_url('comentarios') ?>">Comentarios</a>
                        </li>
                         

                        <li>
                            <a href="<?= base_url('personal') ?>">Personal</a>
                        </li>



                        <li>
                        <a href="<?= base_url('articulos') ?>">Articulos Blog</a>
                        </li>
                        ...
                        <a href="<?= base_url('galeria') ?>">Galeria</a>
                           ...
                           <li class="dropdown ">
                            <a style="margin-top: 1.4px;" href="<?= base_url() ?>" >Ver Web</a>
                        </li>
                    </ul>
                </div><!-- /.navbar-collapse -->
            </div>
